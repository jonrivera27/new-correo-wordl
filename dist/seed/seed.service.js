...
const correo_seed_1 = require("./data/correo.seed");
...
let SeedService = class SeedService {
    constructor(correoService, brandsService) {
        this.correoService = correoService;
        this.brandsService = brandsService;
    }
    populateDB() {
        this.correoService.fillCorreoWhithSeedData(correo_seed_1.CORREO_SEED);
        this.brandsService.fillCoreeoWithSeedData(brands_seed_1.BRANDS_SEED);
